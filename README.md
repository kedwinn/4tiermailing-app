...
## Project Overview
User request goes through a Loadbalancer listening on port 80 and 443 and are then distributed to the registered instances on hosting our Java web app
## 
